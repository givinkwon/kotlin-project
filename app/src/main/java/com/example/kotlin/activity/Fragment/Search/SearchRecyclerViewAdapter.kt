package com.example.kotlin.activity.Fragment.Test
...
class SearchRecyclerViewAdapter(private val context: Context): RecyclerView.Adapter<SearchRecyclerViewAdapter.ViewHolder>() {
