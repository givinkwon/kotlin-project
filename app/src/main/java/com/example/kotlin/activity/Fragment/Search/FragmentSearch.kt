...
import com.example.kotlin.activity.Fragment.Test.SearchRecyclerViewAdapter
...
class FragmentSearch: Fragment() {
    ...
    private lateinit var adapter: SearchRecyclerViewAdapter // 홀더에 데이터를 뿌려주는 Adapter
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // RecyclerView 시작
        // adapter init
        adapter = SearchRecyclerViewAdapter(requireActivity())
