...
class CategoryRecyclerViewAdapter(private val context: Context): RecyclerView.Adapter<CategoryRecyclerViewAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        val user : Category = categoryList[position]
